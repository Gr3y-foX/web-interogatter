...
check_project_files() {
    ...
    [ ! -f "Dockerfile.raspberry" ] && missing_files+=("Dockerfile.raspberry")
    [ ! -f "docker-compose.raspberry.yml" ] && missing_files+=("docker-compose.raspberry.yml")
    [ ! -f "requirements.txt" ] && missing_files+=("requirements.txt")
    [ ! -f "app.py" ] && missing_files+=("app.py")
    [ ! -f "raspberry-run.sh" ] && missing_files+=("raspberry-run.sh")
